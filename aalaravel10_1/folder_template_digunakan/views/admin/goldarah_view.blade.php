...
@section('heading', 'View Golongan Darah')

@section('right_top_button')
<a href="{{ route('admin_goldarah_add') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pt_10 pb_10">
                                        ...
                                        <a href="{{ route('admin_goldarah_edit',$row->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                        <a href="{{ route('admin_goldarah_delete',$row->id) }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure?');">Delete</a>
                                    </td>
                                </tr>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Golongan Darah Detail</h5>
